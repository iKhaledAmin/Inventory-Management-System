...
public record RestockCommand(StockQuantity receivedQuantity, StockExpirationDate expirationDate, StockUnitCost unitCost) {
    ...
    public static RestockCommand of(Long receivedQuantity, LocalDate expirationDate, BigDecimal unitCost){
        return new RestockCommand(
                StockQuantity.of(receivedQuantity),
